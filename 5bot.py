...
cl = LineClient(authToken='Ev9MqT5oYu1MrWvFVAQ6.ZqHTvAetao+CZSt8jKqMHG.1JPNS55m06Lf49u0V6urqPbhZo3ywLcZP6jmRnvVRzQ=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='EvRxMI7rqHPSoOwb9D86.3+6XjxEXmTWEAT2PMxTizG.6DoXxN3ctT8Es1DJA9o4YBUByn2Mp1/+rTOhCQYIIrY=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='Ev8rv9rdzHuX20QFDeP8.Hgk19RkDCdk12cx4t3ouAa.drPPvfU1iGADCdp85lTkVYCUjinhGXHXC5otYSid8fQ=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EvY0W3W7nEb9hTuh8vd2.iI1l6C8BGGcuYC/MUiTuyG.HKM1JRXK/aq8u+EOzD7L7/LLlRfQfYAwLNKuyagvzX4=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

kr = LineClient(authToken='EvcWqIerRS44pBZKX8A3.xI60ZIPHPa8n9pxLhC00eW.Cdn5QQiG2PGHXATUMrn0SF4BMGvdeDSIQQp682vAAXI=')
kr.log("Auth Token : " + str(kr.authToken))
channel3 = LineChannel(kr)
kr.log("Channel Access Token : " + str(channel3.channelAccessToken))

kq = LineClient(authToken='EvOFg9nL8qdMyatt9h1f.PCU6b6w2e0aKbJUzOH6XBW.hcLbpGtCxKyFoXyoKj5HXZi30Z+IA8G1x+UtBW9uFu4=')
kq.log("Auth Token : " + str(kq.authToken))
channel3 = LineChannel(kq)
kq.log("Channel Access Token : " + str(channel3.channelAccessToken))

cxb = LineClient(authToken='EvCpVNq0z39GVM1BP0Od.jlUvitMj+pCXn2q3GtHr7q.jj5RebcvmfKMQq7V+X/qZuDKlT4iQlbGyTdMjAX9D3A=')
